...
Add the required screenshots here:!![sbt](<sbt -s.png>)

### Screenshot of the printSchema inferred in Python

Screenshot goes here!!![py code](<py code -s.png>)

### Screenshot of the printSchema programmatically in Python

Screenshot goes here!!![py schema](<py schema -s.png>)
### Screenshot of the printSchema via DDL in Python

Screenshot goes here!!![python](<py run -s.png>)

### Screenshot of the printSchema inferred in Scala

Screenshot goes here!!![scala code](<scala code -s.png>)

### Screenshot of the printSchema programmatically in Scala

Screenshot goes here!!![schema](<scala schema -s.png>)

### Screenshot of the printSchema via DDL in Scala

Screenshot goes here!!![scala run](<scala run -s.png>)
